...
void initOrientation() {
	//i2c1_pisiRegister(0x1e, 0x4F, 0x6E);
	i2c1_pisiRegister(0x1e, 0x60, 0x4); // ORD
}
/* USER CODE END 0 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(toggle){
		  ...
		  i2c1_beriRegistre(0x1E, 0x68, (uint8_t*) &paket[3], 6); // beri podatke
		  CDC_Transmit_FS((uint8_t*) &paket, 12);
		  ix_paket++;
	  }
